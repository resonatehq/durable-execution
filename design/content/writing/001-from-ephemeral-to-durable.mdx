...
<Figure
  number="Fig. 1"
  caption="Create, call, settle — three frames, all of them pushed by agent itself."
>
  <StackEvolution
    columns={[
      { label: '1', frames: ['agent'] },
      { label: '2', frames: ['agent', 'store.create'] },
      { label: '3', frames: ['agent', 'llm(messages)'] },
      { label: '4', frames: ['agent', 'store.settle'] },
    ]}
  />
</Figure>
...
<Figure
  number="Fig. 2"
  caption="The same three frames, with one slid underneath them. That frame is the entire difference."
>
  <StackEvolution
    accentFrames={['invoke']}
    columns={[
      ...
      { label: '4', frames: ['agent', 'invoke', 'llm(messages)'] },
      { label: '5', frames: ['agent', 'invoke', 'settle promise'] },
    ]}
  />
</Figure>
...
its value without ever reaching step 4. The model is not called again.
